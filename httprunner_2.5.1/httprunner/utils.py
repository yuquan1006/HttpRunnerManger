...
def build_url(base_url, path):
    ...
    if path == "https://account.ihr360.com/ac/login" and base_url == "https://www.ihr360.com":
        return path
    if path == "https://account.ihr360.com/ac/login" and base_url == "https://uat.ihr360.com":
        return "https://passport-uat.ihr360.com/ac/login"
    if path == "https://account.ihr360.com/ac/login" and base_url == "https://beta.ihr360.com":
...
if __name__ == '__main__':
    print(query_json({ "totalPages": 1, "totalElements": 1, "content": [ { "staffId": "53a045dd-35aa-46a9-a040-ddc8fa946584", "staffName": "张十五", "departmentName": "alice钉钉云正式", "enrollInDate": "2021-03-10", "departmentId": 0, "positionId": "bb66ff9b-603d-4cee-a6d3-c783eb7a813a", "positionName": "职位-test-1", "mobileNo": "18123050030", "idCardType": "CHINA_PASSPORT", "idCardNo": "18123050030", "staffStatus": "IN_SERVICE" } ], "page": 0, "rows": 0 },"content.-1.idCardNo"))
